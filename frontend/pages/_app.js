    ...
    return (
        <ApolloProvider client={apollo}>
            <Head>
                ...
                <script crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v8.0&appId=1002148063583402&autoLogAppEvents=1" nonce="o8xuXGfe"></script>
            </Head>
            <Layout>
                <Component {...pageProps} />
            </Layout>
